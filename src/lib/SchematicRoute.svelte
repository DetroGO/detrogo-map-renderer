<script>
    ...
    const getLineColor = (lineName) => {
        ...
        if (normalized.includes("orange")) return "#E65100";
        if (normalized.includes("magenta")) return "#AD1457";
        if (normalized.includes("pink")) return "#E91E8C";
        if (normalized.includes("violet") || normalized.includes("voilet"))
            return "#6A1B9A";
        if (normalized.includes("aqua")) return "#00838F";
